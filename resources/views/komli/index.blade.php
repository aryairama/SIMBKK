...
<script src="{{ asset('js/komli.js') }}"></script>
@endsection
@section('menudb1')
active
@endsection
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-head-row">
                    <h4 class="card-title">Daftar Komli</h4>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="data_table_komli" class="display table table-hover nowrap  w-100 " cellspacing="0">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Keterserapan</th>
