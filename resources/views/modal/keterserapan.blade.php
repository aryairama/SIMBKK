<div class="modal fade create" tabindex="-1" role="dialog" id="modal_dialog" aria-hidden="true">
    <div class=" modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <form class="form_data_keterserapan form-data" enctype="multipart/form-data">
                @csrf
                @method("POST")
                <input type="hidden" name="keterserapan_id" id="keterserapan_id">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input class="form-control form-control-custom p-0" type="text" name="keterserapan_nama"
                                    id="keterserapan_nama" placeholder="Keterserapan">
                            </div>
                        </div>
                    </div>
